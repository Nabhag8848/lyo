...
export const Sidebar = ({ isOpen = true, onClose }: SidebarProps) => {
  ...
  const navLinkClass = ({ isActive }: { isActive: boolean }) =>
    `flex items-center gap-3 px-3 py-2 text-[11px] sm:text-xs font-bold tracking-[0.15em] uppercase transition-colors ${
      isActive
    ...
    <>
      ...
      >
        ...
        <div className="p-6 border-b border-stone-200">
          ...
          <div className="text-[11px] sm:text-xs font-bold tracking-[0.2em] text-stone-500 uppercase mb-2">
            Pro Plan
          </div>
        </div>
        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
          ...
          <a
            href={getWebsiteUrl()}
            className="flex items-center gap-3 px-3 py-2 text-[11px] sm:text-xs font-bold tracking-[0.15em] uppercase text-stone-500 hover:bg-stone-50 hover:text-stone-900 transition-colors"
            onClick={handleNavClick}
          >
            <svg
              className="w-5 h-5"
        ...
        <div className="p-4 border-t border-stone-200">
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2 text-[10px] sm:text-[11px] font-bold tracking-[0.2em] uppercase text-stone-500 hover:text-stone-900 transition-colors"
          >
            <svg
              className="w-5 h-5"
              fill="none"
