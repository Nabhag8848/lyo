      ...
      <div className="max-w-[1600px] mx-auto px-6 h-20 flex items-center justify-between">
        ...
        {user ? (
          ...
          <button
            ...
            className="bg-black text-white px-6 py-3 text-[10px] font-bold tracking-[0.2em] hover:bg-stone-800 transition-all shadow-lg uppercase flex items-center gap-2"
          >
